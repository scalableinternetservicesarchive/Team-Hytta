...
class PhotoalbumsControllerTest < ActionController::TestCase
  ...
  test "should create photoalbum" do
    assert_difference('Photoalbum.count') do
      post :create, photoalbum: { description: @photoalbum.description, name: @photoalbum.name, picture: @photoalbum.picture }
    end
  ...
  test "should update photoalbum" do
    patch :update, id: @photoalbum, photoalbum: { description: @photoalbum.description, name: @photoalbum.name, picture: @photoalbum.picture }
    assert_redirected_to photoalbum_path(assigns(:photoalbum))
  end
